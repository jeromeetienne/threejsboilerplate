...
THREEx.DragPanControl	= function(object, domElement)
{
	this._object	= object;
	this._domElement= domElement || document;

	// parameter that you can change after initialisation
...
THREEx.DragPanControl.prototype.destroy	= function()
{
...
THREEx.DragPanControl.prototype.update	= function(event)
{
...
THREEx.DragPanControl.prototype._onMouseMove	= function(event)
{
	this._mouseX	= ( event.clientX / window.innerWidth ) - 0.5;
	this._mouseY	= ( event.clientY / window.innerHeight) - 0.5;
}

THREEx.DragPanControl.prototype._onTouchStart	= function(event)
{
...
THREEx.DragPanControl.prototype._onTouchMove	= function(event)
{
	if( event.touches.length != 1 )	return;
